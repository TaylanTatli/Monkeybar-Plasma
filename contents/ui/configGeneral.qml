        ...
        Kirigami.FormLayout {
            ...
            QQC2.ComboBox {
                ...
                model: [
                    ...
                    { value: 7200, text: i18n("2 hours") },
                    { value: 14400, text: i18n("4 hours") },
                    { value: 21600, text: i18n("6 hours") },
                    { value: 43200, text: i18n("12 hours") },
                    { value: 86400, text: i18n("24 hours") }
                ]
            ...
            QQC2.ComboBox {
                ...
                valueRole: "value"
                model: [
                    { value: "sunday", text: i18n("Sunday") },
                    { value: "monday", text: i18n("Monday") },
                    { value: "tuesday", text: i18n("Tuesday") },
                    { value: "wednesday", text: i18n("Wednesday") },
                    { value: "thursday", text: i18n("Thursday") },
                    { value: "friday", text: i18n("Friday") },
                    { value: "saturday", text: i18n("Saturday") }
                ]
                currentIndex: Math.max(0, model.findIndex(item => item.value === value))
                onActivated: value = currentValue
            ...
            QQC2.ComboBox {
                ...
                valueRole: "value"
                model: [
                    { value: "standard", text: i18n("Monkeytype") },
                    { value: "githubDark", text: i18n("GitHub Green") },
                    { value: "halloween", text: i18n("Halloween") },
                    { value: "teal", text: i18n("Teal") },
                    { value: "leftPad", text: i18n("@left_pad") },
                    { value: "dracula", text: i18n("Dracula") },
                    { value: "blue", text: i18n("Blue") },
                    { value: "panda", text: i18n("Panda") },
                    { value: "sunny", text: i18n("Sunny") },
                    { value: "pink", text: i18n("Pink") },
                    { value: "solarizedDark", text: i18n("Solarized Dark") },
                    { value: "solarizedLight", text: i18n("Solarized Light") }
                ]
                currentIndex: Math.max(0, model.findIndex(item => item.value === value))
                onActivated: value = currentValue
            ...
            QQC2.ComboBox {
                ...
                valueRole: "value"
                model: [
                    { value: "opacity", text: i18n("Opacity") },
                    { value: "grade", text: i18n("Grade") }
                ]
                currentIndex: Math.max(0, model.findIndex(item => item.value === value))
                onActivated: value = currentValue
            ...
            QQC2.ComboBox {
                ...
                valueRole: "value"
                model: [
                    { value: "flexible", text: i18n("Flexible") },
                    { value: "fixed", text: i18n("Fixed") }
                ]
                currentIndex: Math.max(0, model.findIndex(item => item.value === value))
                onActivated: value = currentValue
